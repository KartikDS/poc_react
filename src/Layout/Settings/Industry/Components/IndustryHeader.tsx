...
function IndustryHeader(props: { title: string; totalRecords: number; handleOpen: () => void }) {
  return (
    <>
        ...
        <div className={styles.SubHead}>
          ...
          <div>
            <Button className="customBtn SmBtn" onClick={() => props.handleOpen()}>
              <Image alt="add" height={16} width={16} src="/assets/icons/add.svg" /> Add a new industry
            </Button>
          </div>
        </div>
      </div>
